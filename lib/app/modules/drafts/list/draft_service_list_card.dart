...
class DraftServiceListCard extends StatelessWidget {
  final DraftsController controller;

  DraftServiceListCard({@required this.controller});
      ...
      child: Column(
        children: <Widget>[
          Container(
            ...
            child: ListTile(
              title: Text(
                lists.arrayList[ListType.services.index],
                style: TextStyle(
              ...
              onTap: () {
                String hash = ListType.services.toString().split(".")[1];
          ...
          Observer(
            builder: (_) => ListView.builder(
              itemCount: controller.draft.services.length,
